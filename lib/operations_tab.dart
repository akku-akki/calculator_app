        ...
        children: [
          ...
          Padding(
            ...
            child: MaterialSegmentedControl(
              key: Key('operation_selector'),
              children: {
                0: Text('+', key: Key("ADDITION")),
                1: Text('-'),
                2: Text('x', key: Key('Multiply'),),
                3: Text(
                  '/',
                  key: Key("DIVIDE"),
                ),
          ...
          PiWidget(calculator: widget.calculator,)
        ],
      ),
    );
  }
